                ...
                <tr key={station.id} className="hover:bg-surface-hover transition-colors">
                  ...
                  <td className="p-4 text-right">
                    <div className="flex items-center justify-end gap-3 relative">
                      ...
                      {/* Primary Action */}
                      <button className="text-sm font-bold text-white bg-brand hover:bg-brand-hover transition-all px-4 py-2 rounded-lg shadow-[0_0_14px_rgba(16,185,129,0.2)] hover:shadow-[0_0_20px_rgba(16,185,129,0.35)] active:scale-95">
                        Print Label
                      </button>
